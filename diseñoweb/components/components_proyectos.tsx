    ...
    <section id="proyectos" className="py-20 bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          <Link href="https://github.com/sergio001g" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 text-lg font-semibold">
            Ver mi perfil completo en GitHub
          </Link>
        </div>
      </div>
    </section>
